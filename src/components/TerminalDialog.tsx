...
const TerminalDialog = ({ open, onOpenChange }: TerminalDialogProps) => {
  ...
  const [history, setHistory] = useState<TerminalLine[]>([
    { type: 'output', content: 'Welcome to niko\'s terminal. Type "help" for commands.' },
  ]);
  ...
  5. clear   - Clear terminal`;
        break;
      case 'server':
        response = '🎮 Discord: https://discord.gg/FDPC6xajtn';
        break;
      case 'about':
        response = `👤 About Me:
  Name: Niko
  Age: 19
  Profession: Bot Developer / Web Development`;
        break;
      case 'webinfo':
